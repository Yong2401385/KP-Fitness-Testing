...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (str_contains($userMessage, 'hello') || str_contains($userMessage, 'hi')) {
        ...
        $response['reply'] = "Our classes include HIIT Training, Yoga Flow, Strength Training, Cardio Blast, and Pilates Core. Check out the full schedule and book a class on our <a href='" . SITE_URL . "/client/booking.php'>Class Booking page</a>.";
